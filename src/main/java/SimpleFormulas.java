...
//        double max = Math.abs(function.apply(0.) + uDer.apply(0.) * delta + (uSecDer.apply(0.) / PhiDerSec.apply(0.)) * (Phi.apply(0. + delta) -
//               -Phi.apply(0.) - PhiDer.apply(0.)*delta) - function.apply(0. + delta));
        uNorm[i] = Math.abs(function.apply(uzel[i]) - uDer.apply(uzel[i]) * delta + ((Phi.apply(uzel[i] + delta) - Phi.apply(uzel[i]) - PhiDer.apply(uzel[i])*delta)) * uSecDer.apply(uzel[i]) / PhiDerSec.apply(uzel[i]) - function.apply(uzel[i] - delta));
//            System.out.println(uNorm[i]);
