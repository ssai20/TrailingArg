...
//        System.out.println("error norm modified = "+errorNormModified);
        ...
        Combine combine = new Combine("/home/funforces/Articles/Trailing/");
        combine.latex.latexHeadDocument();
        combine.latexTable();
        combine.latex.latexEndDocument();
        combine.latex.compileAndOpenPDFFile();
