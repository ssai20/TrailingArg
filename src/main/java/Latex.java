...
//    }
    ...
    //                    norm[i] = Math.abs(uDerivativeNewMethod[i] - uAccuracyDerivative[i]);
    //                }
    //            }
...
//            bw.write("\\cline{2-6}& $32$&$64$& $128$&$256$&$512$&$1024$ \\\\");
    ...
    public void latexTable(String[][] residual, String[][] oa) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file, true), "UTF-8"))) {
                        ...
                        bw.write("$1$");
                        bw.newLine();
                        bw.write("&$".concat(residual[0][0]) + "$&$".concat(residual[0][1]) + "$&$".concat(residual[0][2]) + "$&$".concat(residual[0][3]) + "$& $".concat(residual[0][4]) /*+ "$& $".concat(residual[0][5])*/ + "$\\\\");
                        bw.newLine();
            bw.write("&$".concat(oa[0][0]) + "$&$".concat(oa[0][1]) + "$&$".concat(oa[0][2]) + "$&$".concat(oa[0][3]) + "$& $".concat(oa[0][4]) /*+ "$& $".concat(residual[0][5])*/ + "$\\\\");
            bw.newLine();
            //            bw.write("$o.a.$ &".concat(oa[0][0]) + "&".concat(oa[0][1]) + "& ".concat(oa[0][2]) + "&".concat(oa[0][3]) + "&".concat(oa[0][4]) + "&\\\\");
            //            bw.newLine();
                        bw.write("\\cline{1-6}");
                        bw.newLine();
                        bw.write("$10^{-1}$");
                        bw.newLine();
                        bw.write("&$".concat(residual[1][0]) + "$&$".concat(residual[1][1]) + "$&$".concat(residual[1][2]) + "$&$".concat(residual[1][3]) + "$&$".concat(residual[1][4]) /*+ "$& $".concat(residual[1][5]) */+ "$\\\\");
                        bw.newLine();
            bw.write("&$".concat(oa[1][0]) + "$&$".concat(oa[1][1]) + "$&$".concat(oa[1][2]) + "$&$".concat(oa[1][3]) + "$&$".concat(oa[1][4]) /*+ "$& $".concat(residual[1][5]) */+ "$\\\\");
            bw.newLine();
            //            bw.write("$o.a.$&".concat(oa[1][0]) + "&".concat(oa[1][1]) + "&".concat(oa[1][2]) + "&".concat(oa[1][3]) + "&".concat(oa[1][4]) + "&\\\\");
            //            bw.newLine();
                        bw.write("\\cline{1-6}");
                        bw.newLine();
                        bw.write("$10^{-2}$");
                        bw.newLine();
                        bw.write("&$".concat(residual[2][0]) + "$&$".concat(residual[2][1]) + "$&$".concat(residual[2][2]) + "$&$".concat(residual[2][3]) + "$&$".concat(residual[2][4]) /*+ "$& $".concat(residual[2][5]) */+ "$\\\\");
                        bw.newLine();
            bw.write("&$".concat(oa[2][0]) + "$&$".concat(oa[2][1]) + "$&$".concat(oa[2][2]) + "$&$".concat(oa[2][3]) + "$&$".concat(oa[2][4]) /*+ "$& $".concat(residual[2][5]) */+ "$\\\\");
            bw.newLine();
            //            bw.write("$o.a.$&".concat(oa[2][0]) + "&".concat(oa[2][1]) + "&".concat(oa[2][2]) + "&".concat(oa[2][3]) + "&".concat(oa[2][4]) + "&\\\\");
            //            bw.newLine();
                        bw.write("\\cline{1-6}");
                        bw.newLine();
                        bw.write("$10^{-3}$");
                        bw.newLine();
                        bw.write("&$".concat(residual[3][0]) + "$&$".concat(residual[3][1]) + "$&$".concat(residual[3][2]) + "$&$".concat(residual[3][3]) + "$&$".concat(residual[3][4]) /*+ "$& $".concat(residual[3][5]) */+ "$\\\\");
                        bw.newLine();
            bw.write("&$".concat(oa[3][0]) + "$&$".concat(oa[3][1]) + "$&$".concat(oa[3][2]) + "$&$".concat(oa[3][3]) + "$&$".concat(oa[3][4]) /*+ "$& $".concat(residual[3][5]) */+ "$\\\\");
            bw.newLine();
            //            bw.write("$o.a.$&".concat(oa[3][0]) + "&".concat(oa[3][1]) + "&".concat(oa[3][2]) + "&".concat(oa[3][3]) + "&".concat(oa[3][4]) + "&\\\\");
            //            bw.newLine();
                        bw.write("\\cline{1-6}");
                        bw.newLine();
                        bw.write("$10^{-4}$");
                        bw.newLine();
                        bw.write("&$".concat(residual[4][0]) + "$&$".concat(residual[4][1]) + "$&$".concat(residual[4][2]) + "$&$".concat(residual[4][3]) + "$&$".concat(residual[4][4]) /*+ "$ & $".concat(residual[4][5])*/ + "$\\\\");
                        bw.newLine();
            bw.write("&$".concat(oa[4][0]) + "$&$".concat(oa[4][1]) + "$&$".concat(oa[4][2]) + "$&$".concat(oa[4][3]) + "$&$".concat(oa[4][4]) /*+ "$ & $".concat(residual[4][5])*/ + "$\\\\");
            bw.newLine();
